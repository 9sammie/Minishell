...
int    manage_simple_quote(char *promptline, int *i, t_boolean *booleans, t_data *data, int *word_length)
{
...
int    manage_double_quote(char *promptline, int *i, t_boolean *booleans, t_data *data, int *word_length)
{
